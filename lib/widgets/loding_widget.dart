...
class _LoadingWidgetState extends State<LoadingWidget> {
  ...
  void didChangeDependencies() {
    ...
    //I will call the lesson false because we don't have to listen to the changes.
    ...
    return widget.newsType == NewsType.topTrending
        ? SizedBox(
            ...
            child: Swiper(
              autoplayDelay: 8000,
              autoplay: true,
              viewportFraction: 0.8, //sayfalari birbirine yakin gostermek icin
